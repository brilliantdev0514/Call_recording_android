...
import com.smart.callrec.ui.adapter.ViewPagerAdapter;
import com.smart.callrec.ui.all.AllCallFragment;
import com.smart.callrec.ui.coming.InComingFragment;
import com.smart.callrec.ui.going.OutGoingFragment;
import com.smart.callrec.ui.inportant.ImportantFragment;
import com.smart.callrec.ui.navigation.NavigationDrawerFragment;
import com.smart.callrec.ui.setting.general.PinActivity;
import com.smart.callrec.ui.theme.MaterialTheme;
import com.smart.callrec.ui.theme.SetThemeDialogFragment;
import com.smart.callrec.util.Constants;
import com.smart.callrec.util.DialogUtils;
    ...
    public void onNavigationDrawerItemSelected(int type, int position) {
        switch (position) {
            ...
            case 3:
                ...
                break;
            case 4:
                Intent intentHelp = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.smart.callrec"));
